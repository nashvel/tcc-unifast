...
const endpointGroups: EndpointGroup[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/api/student/requirement-vault/document", summary: "Upload course history (PDF), grade slip (PDF), or ID back-to-back & specimen (PDF or image).", access: "student", throttle: "20/min", request: "FormData: file, slot_key", response: '{ "data": {...} }' },

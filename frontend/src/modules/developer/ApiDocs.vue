...
const endpointGroups: EndpointGroup[] = [
  {
    ...
    endpoints: [
      { method: "GET", path: "/api/auth/captcha", summary: "Create a login captcha challenge.", access: "public", throttle: "30/min", response: '{ "image": "data:image/svg+xml;base64,...", "key": "..." }' },
      { method: "POST", path: "/api/auth/login", summary: "Authenticate a user and issue a Sanctum token.", access: "public", throttle: "5/min", request: '{ "email": "...", "password": "...", "captcha": "..." }', response: '{ "user": {...}, "token": "..." }' },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/api/student/identity-onboarding/id-scan", summary: "Store the onboarding school ID scan.", access: "student", throttle: "10/min", request: "FormData: id_image, qr_payload, extracted_text, consent_accepted", response: '{ "data": {...} }' },
      ...
      { method: "POST", path: "/api/student/requirement-vault/id", summary: "Upload the live school ID scan for the active batch.", access: "student", throttle: "20/min", request: "FormData: file, slot_key=school_id, metadata", response: '{ "data": {...} }' },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "GET", path: "/api/files", summary: "List managed files.", access: "operations", response: '{ "data": [...], "meta": {...} }' },

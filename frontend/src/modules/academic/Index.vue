...
import { useAcademicList } from "@/composables/useAcademic";
...
const { records, meta, query: recordsQuery } = useAcademicList({
  page: () => page.value,
...
function remarkCount(record: { remarks: { passed: number; failed: number; dropped: number } }, remark: CourseRemark) {

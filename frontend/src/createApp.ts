...
const appChildren: RouteRecordRaw[] = [
  ...
  { path: "social-posts", redirect: (to) => withLang("/app/announcements?tab=social", to.query.lang) },
  ...
  { path: "billing", redirect: (to) => withLang("/app/reports?tab=billing", to.query.lang) },
  { path: "distribution", redirect: (to) => withLang("/app/reports?tab=distribution", to.query.lang) },
  ...
  { path: "security/memory", redirect: (to) => withLang("/app/security?tab=memory", to.query.lang) },

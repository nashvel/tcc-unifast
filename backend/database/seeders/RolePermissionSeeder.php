...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'grantees.write', 'description' => 'Create, update, and manage grantee registry records', 'category' => 'Grantees'],
            ['name' => 'academic.read', 'description' => 'View academic history', 'category' => 'Academic'],
            ['name' => 'academic.write', 'description' => 'Create and update academic records', 'category' => 'Academic'],
            ...
            // ── Route-level & CRUD operational permission slugs ──
            ['name' => 'view_masterlist', 'description' => 'View and import the grantee masterlist', 'category' => 'Operations'],
            ['name' => 'masterlist.read', 'description' => 'View and filter masterlist records', 'category' => 'Operations'],
            ['name' => 'masterlist.write', 'description' => 'Import and update masterlist records', 'category' => 'Operations'],
            ...
            ['name' => 'eligibility.read', 'description' => 'View student eligibility evaluations', 'category' => 'Validation'],
            ['name' => 'eligibility.write', 'description' => 'Perform eligibility overrides and rule evaluation', 'category' => 'Validation'],
            ['name' => 'publish_announcements', 'description' => 'Create and publish announcements to students', 'category' => 'Communication'],
            ['name' => 'announcements.read', 'description' => 'View announcements and drafts', 'category' => 'Communication'],
            ['name' => 'announcements.write', 'description' => 'Create, edit, and dispatch announcements', 'category' => 'Communication'],
            ['name' => 'generate_reports', 'description' => 'Generate and download billing and distribution reports', 'category' => 'Communication'],
            ['name' => 'reports.read', 'description' => 'View billing and distribution reports', 'category' => 'Communication'],
            ['name' => 'reports.write', 'description' => 'Generate, recalculate, and export billing data', 'category' => 'Communication'],
            ['name' => 'manage_support', 'description' => 'View and respond to support tickets', 'category' => 'Communication'],
            ['name' => 'support.read', 'description' => 'Read student support tickets', 'category' => 'Communication'],
            ['name' => 'support.write', 'description' => 'Create ticket responses and change ticket status', 'category' => 'Communication'],
        ...
        $roles = [
            ...
            [
                ...
                'permissions' => [
                    ...
                    'grantees.read', 'grantees.write', 'academic.read', 'academic.write',
                    'documents.read', 'documents.write',
                    // Route-level & CRUD slugs
                    'view_masterlist', 'masterlist.read', 'masterlist.write',
                    'manage_batches', 'manage_grantees',
                    'validate_documents', 'review_academics', 'run_eligibility',
                    'eligibility.read', 'eligibility.write',
                    'publish_announcements', 'announcements.read', 'announcements.write',
                    'generate_reports', 'reports.read', 'reports.write',
                    'manage_support', 'support.read', 'support.write',
            ...
            [
                ...
                'is_system' => true,
                'permissions' => [
                    'grantees.read', 'grantees.write', 'documents.read', 'documents.write',
                    'academic.read', 'academic.write', 'batches.read', 'batches.write',

...
export function StudentBottomNav() {
  ...
  return (
    ...
    >
      <ul className="pointer-events-auto mx-auto flex w-fit max-w-[22rem] items-center justify-center gap-1.5 rounded-full border bg-surface/95 backdrop-blur supports-[backdrop-filter]:bg-surface/80 px-2 py-2 shadow-pop">
        {items.map((it) => {

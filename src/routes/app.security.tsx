...
interface Finding {
  id: string;
  scanner: "supabase" | "supabase_lov" | "connector_security_scan";
  scannerLabel: string;
  name: string;
  description: string;
  level: Level;
 ...
 * - `supabase`            — built-in Supabase platform checks
 * - `supabase_lov`        — Lovable's Supabase posture scanner
...
const FINDINGS: Finding[] = [
  {
    ...
    scannerLabel: "Supabase (Lovable scanner)",
  ...
  },
  {
    ...
    scanner: "supabase",
    scannerLabel: "Supabase platform",
...
const SCANNERS = [
  { key: "supabase", label: "Supabase platform" },
  { key: "supabase_lov", label: "Supabase (Lovable scanner)" },
